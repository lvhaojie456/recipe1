...
export const ChefHat = ({ className = "w-6 h-6" }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M6 13.87A4 4 0 0 1 7.41 6a5.11 5.11 0 0 1 10.59 0A4 4 0 0 1 22 11.83V16a2 2 0 0 1-2 2h-2"/><path d="M22 16a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V9.457c0-1.724 1.155-3.238 2.822-3.699a7.653 7.653 0 0 1 12.356 0C18.845 6.22 20 7.733 20 9.457V16"/><path d="M2 12h20"/><path d="M12 18v4"/><path d="M8 22h8"/></svg>
);
...
export const Flame = ({ className = "w-4 h-4" }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M8.5 14.5A2.5 2.5 0 0 0 11 12c0-1.38-.5-2-1-3-1.072-2.143-.224-4.054 2-6 .5 2.5 2 4.9 4 6.5 2 1.6 3 3.5 3 5.5a7 7 0 1 1-14 0c0-1.115.385-2.256 1-3.243 1.25.957 1.5 1.743 1.5 2.743Z"/></svg>
);
...
export const Activity = ({ className = "w-4 h-4" }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M22 12h-4l-3 9L9 3l-3 9H2"/></svg>
);

export const TrendingUp = ({ className = "w-4 h-4" }: { className?: string }) => (
...
export const Network = ({ className = "w-4 h-4" }: { className?: string }) => (
...
export const X = ({ className = "w-4 h-4" }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M18 6 6 18"/><path d="m6 6 12 12"/></svg>
);

export const Sliders = ({ className = "w-4 h-4" }: { className?: string }) => (
